...
public static void Run(String myEventHubMessage, out string outputEventHubMessage, TraceWriter log)
{
    log.Info($"C# Timer trigger function executed because of event: {myEventHubMessage}");
    pollForTasks(log);    
    outputEventHubMessage = "polled"; // Todo: yeah - should do better
}
